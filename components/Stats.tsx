...
const Stats: React.FC = () => {
  return (
    <section id="stats" className="bg-surface/30 border-y border-neon-gold/10 shadow-[0_0_20px_rgba(251,191,36,0.02)] backdrop-blur-sm relative z-20">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-between items-center py-12 gap-8">
          {stats.map((stat) => (
            <div key={stat.id} className="flex-1 flex flex-col items-center text-center group cursor-default">
              <span className="font-sans text-4xl md:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-white to-dim group-hover:from-neon-gold group-hover:to-amber-200 transition-all duration-500 mb-3 drop-shadow-[0_0_10px_rgba(255,255,255,0.05)] group-hover:drop-shadow-[0_0_15px_rgba(251,191,36,0.4)]">
                {stat.value}
              </span>
